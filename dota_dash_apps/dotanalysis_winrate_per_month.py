...
#------------------ APP LAYOUT
app.layout = html.Div([
    dbc.Row(dbc.Col(html.H3("Winrate per Month", style={'text-align': 'left'}),
    ...
    dbc.Row(dbc.Col(html.Div(id='team-matches-month-dbc'))),
])
...
@app.callback(
    Output('matches-month-dbc', 'children'),
    Input('team-matches-month-dbc', 'clickData'),
)
